...
const Img = (props) => {
    ...
    // initial={{x:0}} animate={{x: displacementElem()}} transition={{duration: picturesHight.length*2 * distance/timeZone, repeat: Infinity, ease: "linear"}}
    ...
    return (
        ...
        <motion.div onClick={setParams} className="picture" >
            ...
            <ImgOnAllWindow activePool={props.setActive} active={activeModul} setActive={setActiveModul} img={img_st} img_png={props.photo.img_png}/>
        </div>
    );
};
