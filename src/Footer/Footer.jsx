...
import insta from "../picture_izBrazzerie/insta.png";
                ...
                <motion.div className="footer_block4_mainPage"
                        ...
                        <div className="text_one">
                            <div className="puncts">
                                <div className="elems_footer_one">
                                    ...
                                    <a className="linker" href="/iz_brazeri">IZ BRASSERIE</a>
                                    <a className="linker" href="/konditoria">KONDITORIA</a>
                                </div>
                            </div>
                        </div>
                        <div className="text_two">
                            <div className="puncts_two">
                                <div className="elems_footer_two">
                                    ...
                                    <a className="linker" href="/menu">ДОСТАВКА</a>
                    ...
                    <div className="links_logo">
                        <div className="link_pool">
                            ...
                            {/*<a href="https://instagram.com/izbrasseriegroup" className="link_elem"><img className='instaPic' src={insta}/></a>*/}
                        </div>
                        ...
                        <div className="text_one">
                            <div className="puncts">
                                <div className="elems_footer_one">
                                    <a className="linker" href="/about">О ПРОЕКТЕ</a>
                                    <a className="linker" href="/sibumi">SIBUMI</a>
                                    <a className="linker" href="/iz_brazeri">IZ BRAZERIE</a>
                                    <a className="linker" href="/konditoria">KONDITORIA</a>
                                </div>
                            </div>
                        </div>
