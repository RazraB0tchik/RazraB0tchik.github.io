...
const BlockTwo = ({state}) => {
    ...
    return (
        <div className="block2">
            ...
            <div className="text_blockTwo"><motion.p variants={VarianceText} transition={{duration: 1, delay: 1}}>У нас для вас кое-что приятное. Мы объединили доставку из наших проектов: кондитерской КОНДИТОРИЯ, ресторана японской и паназиатской кухни SIBUMI и одноименного гастропаба IZ BRASSERIE. Теперь вы можете быстро и удобно заказать доставку самой разной кухни - домой. Для заказа, спуститесь ниже и начните поиск блюд.</motion.p></div>
