    ...
    if (props.type === "normal") {
        return (
            <motion.div className="card_massive" initial='close' whileInView='open' viewport={{once: true, amount: 0.1}}>
                ...
                <motion.div className="card_button" transition={{duration: 1, delay: 1.5}} variants={VarianceButton}>
                    <motion.a href="/menu" className="butcard" whileHover={{borderColor: "rgb(206, 189, 160)", color: "rgb(206, 189, 160)", opacity: 1}}>ПЕРЕЙТИ В МЕНЮ</motion.a>
                </motion.div>
            </motion.div>
        );
    }
        ...
        return (
            <motion.div className="card_massive_mobile" initial='close' whileInView='open' viewport={{once: true, amount: 0.1}}>
                ...
                <motion.div className="card_button" transition={{duration: 1, delay: 1.5}} variants={VarianceButton}>
                    {/*<link href="/menu">*/}
                    <motion.a href="/menu" className="butcard_mobile" whileHover={{borderColor: "rgb(206, 189, 160)", color: "rgb(206, 189, 160)", opacity: 1}}>ПЕРЕЙТИ В МЕНЮ</motion.a>
                    {/*</link>*/}
                </motion.div>
