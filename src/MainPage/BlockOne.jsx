...
//                         <motion.div className="title_one_MainPage" initial={{y: "-100%"}} animate={{y: 0}}  transition={{duration: 1, delay: 1}}><h1 className="text_title_MainPage">SIBUMI</h1></motion.div>
//                     </div>
//
//                     <div className="mainBlock_with_title_two">
//                         <motion.div className="title_two_MainPage" initial={{y: "-100%"}} animate={{y: 0}}   transition={{duration: 1, delay: 1.5}}><h1 className="text_title_two_MainPage">KONDIT</h1><h1 className="gold_letter_MainPage">ORIA</h1></motion.div>
//                     </div>
//                 </motion.div>
//                 <motion.div className="title_gold_background_MainPage" initial={{y: "-100%", opacity: 0}} animate={{y: 0, opacity: 1}} transition={{duration: 1, delay: 1.5}}>
//                     <motion.div className="title_three_MainPage" initial={{y: "-100%"}} animate={{y: 0}}   transition={{duration: 1, delay: 2}}><h1 className="text_title_MainPage">IZ BRASSERIE</h1></motion.div>
//                 </motion.div>
//             </div>
//
//             <div className="photo_background_MainPage">
